...
function SheetClose({ nativeButton, ...props }: DialogPrimitive.Close.Props) {
  return (
    <DialogPrimitive.Close
      data-slot="sheet-close"
      // Base UI's Close primitive assumes a native <button> by default; when
      // composed with a non-button element (e.g. a Link, as in the mobile
      // nav) that needs to be false, same fix as components/ui/button.tsx.
